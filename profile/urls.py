...
from profile.views import profile_form, update_profile, get_profile_data, return_profile_page, payment_apartment
...
urlpatterns = [
    ...
    path('payment/<int:apartment_id>/<int:user_id>', payment_apartment, name="Payment Apartment"),
]
